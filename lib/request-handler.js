...
class RequestHandler {
     ...
     * @author Alaa Attya <alaa.attya91@gmail.com>
     */
    async getRequest(endpoint, requestData = {}) {
        return await this.axios.get(endpoint, requestData);
    }
     ...
     * @author Alaa Attya <alaa.attya91@gmail.com>
     */
    async putRequest(endpoint, requestData = {}) {
        return await this.axios.put(endpoint, requestData);
    }
     ...
     * @author Alaa Attya <alaa.attya91@gmail.com>
     */
    async deleteRequest(endpoint, requestData = {}) {
        return await this.axios.delete(endpoint, requestData);
    }
