...
const transformSearchPayload = (searchParams, apiCredentials, opts = {}) => {

    // const jsonData = {
    //     Root: {
    //         Header: {
    //             Agency: apiCredentials.agency,
    //             User: apiCredentials.username,
    //             Password: apiCredentials.password,
    //             Operation: opts.operation, //OperationType.HOTEL_SEARCH_REQUEST,
    //             OperationType: opts.operationType, //'Request',
    //         },
    //         Main: {
    //             '@Version': apiCredentials.apiVersion, // to make it xml response, set Version=1 and ResponseFormat="XML"
    //             '@ResponseFormat': 'JSON',
    //             SortOrder: opts.searchOrder,
    //             FilterPriceMin: 1,
